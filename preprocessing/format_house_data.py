...
def format_house_data(house_number: int):
    start = time.time()
    # Read import kw csv
    import_df = pd.read_csv(r'../house_raw_data/house{}_import_kw.csv'.format(house_number),
    ...
    # Read export kw csv
    export_df = pd.read_csv(r'../house_raw_data/house{}_export_kw.csv'.format(house_number),
                            usecols=['timestamp', 'value'])
    ...
    # Read pv kw csv
    pv_df = pd.read_csv(r'../house_raw_data/house{}_pv_kw.csv'.format(house_number),
                        usecols=['timestamp', 'value'])
    ...
    # Read battery kw csv
    battery_df = pd.read_csv(r'../house_raw_data/house{}_battery_kw.csv'.format(house_number),
    ...
    weather_df = pd.read_csv(r'../weather_data/weather_data.csv', parse_dates=['DATE'], index_col='DATE')
    ...
    joined_df.to_csv(r'../house_data/uncleaned/house{}.csv'.format(house_number, house_number), index=False)
    end_time = time.time()
