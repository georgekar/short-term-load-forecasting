...
def format_house_data(house_number: int):
    ...
    import_df.to_csv('../../data/house_raw_data/house{}_import_kw.csv'.format(house_number), index=False,
                     single_file=True)
    export_df.to_csv('../../data/house_raw_data/house{}_export_kw.csv'.format(house_number), index=False,
                     single_file=True)
    pv_df.to_csv('../../data/house_raw_data/house{}_pv_kw.csv'.format(house_number), index=False,
                 single_file=True)
    battery_df.to_csv('../../data/house_raw_data/house{}_battery_kw.csv'.format(house_number), index=False,
                      single_file=True)
    end_time = time.time()
